...
public class Consume_RestTemplate { // consuming APIs
    ...
    public ResponseEntity<User[]> readAllUsers() {
        // takes the URI and gives from DTO, advantage of it you can modify what to be shown
        return restTemplate.getForEntity(URI, User[].class); // getForEntity accepts array
    }

    @GetMapping("{id}")
    public Object readUser(@PathVariable("id") Integer id) { // no need DTO here
